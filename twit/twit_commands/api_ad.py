...
from decimal import Context, setcontext, Decimal, BasicContext
#valuecontext = Context(prec=9)
setcontext(BasicContext)

def run_ad_command(command, player, args):
    ...
    if args_len in {1}:
        ...
        # get player balance, calculate, send update to database
