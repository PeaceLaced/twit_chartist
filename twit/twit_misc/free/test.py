...
class GameState(object):
    ...
    def update_screen(self, screen):
        ...
        if len(self.images) <= 0:
            # 
            self.load_image(screen, "twit/twit_misc/free/img/grumpy_cat.jpg")
            self.load_image(screen, "twit/twit_misc/free/img/colour_globe.gif")
            self.load_image(screen, "twit/twit_misc/free/img/wall.png")

        # Demo uses static sprites, so can reset every time now we have images loaded.
        self.sprites = [
            Sprite(self, 3.5, 6.5, self.images["twit/twit_misc/free/img/grumpy_cat.jpg"]),
            Sprite(self, 14.5, 11.5, self.images["twit/twit_misc/free/img/colour_globe.gif"]),
            Sprite(self, 0, 0, self.images["twit/twit_misc/free/img/wall.png"])
        ]
