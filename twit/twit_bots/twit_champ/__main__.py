...
# MINOR TODOs
#############
# TODO: reset - command (champ) - ??? WIT   - reset the modifier to 0.1
# TODO: figure out how to get WIT distribute at the top of every minute
###############################################################################
# MAJOR TODOs
#############
# TODO: (1)pubsub and the db fields in champ to go along with this version of play
# TODO: continue working on distribution routine
#   - add an active field
#   - add a time field
#     -- used to propigate remaining time to the next game/day
#   - add timestamp field
###############################################################################        
