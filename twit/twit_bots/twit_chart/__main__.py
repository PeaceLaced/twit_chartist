...
from twit.twit_api.api_command_handler import get_player_data, update_player, calc_play_time
...
# pubsub
    ...
    async def event_pubsub_channel_points(self, event: pubsub.PubSubChannelPointsMessage):
        ''' pubsub event handler (add more later)
        (a), 20 min cost 10 points, 60 min cooldow
        (b), 20 min cost 100 points, 20 min cooldown
        (c), 20 min cost 1000 points, 0 cooldown
        '''
