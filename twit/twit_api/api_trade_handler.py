...
def update_symbol_list(tda_client):
    ...
    # moved avoid list to top of script for easier access
    # (28 FEB 2022, wait_for_fill, unable to fill crashed the script, see MAIN log)
    # nevermind, it was because pre-market (09:29:19)
